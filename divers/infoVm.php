                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header card-header-info">
                                <h4 class="card-title ">Information générale sur les VMs</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    $response = httpGet('http://127.0.0.1/api/getallmachine.php');
                                    $response = json_decode($response, true);


                                    echo '<table class="align-content-center table table-responsive">
