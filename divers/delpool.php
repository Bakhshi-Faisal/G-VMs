                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header card-header-info">
                                <h4 class="card-title">Suppression des pools</h4>
                            </div>
                            ...
                            foreach ($response as $m) {
                                echo
                                    ...
                                    "<td>" . $m['path_vol']. "</td>" ;
                                echo "<td>";
                                echo '<a href="?diskdel='.$m['path_vol'].'">';
                                echo "supprimer";
                                echo '</a>';
                                "</td>";
                        ...
                        echo '</table>';
                            $action = array_key_exists('diskdel', $_GET) ? $_GET['diskdel'] : false;

                            if ($action) {
                                $url = "http://localhost/api/supPool.php?diskdel=" . $_GET['diskdel'];
