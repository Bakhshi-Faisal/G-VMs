                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <form class="m-3" action="vm.php" method="POST">
                                <div class="col-md-4">
                                    <label>Nom</label>
                                </div>
                                <div class="col-md-5">
                                ...
                                <div class="col-md-5">
                                    <select name="disk" class="form-control">
                                        ...
                                        foreach ($response as $vol) {

                                            echo"<option value='". $vol['path_vol'] ."'>". $vol['nom_vol'] ."</option>";
                                ...
                                <div class="col-md-2" id="submit-button">
                                    <input type="submit" class="btn btn-outline-info" value="Créer"/>
                                </div>
                            </form>
