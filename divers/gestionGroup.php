                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        foreach ($response as $m) {
                            echo '
                 <div class="card text-dark bg-white m-3" style="max-width: 18rem;">
  <div class="card-header">'.$m['groupe'].'</div>
  <div class="card-body">
    <h5 class="card-title text-dark ">'.$m['vms'].'</h5>
    <p class="card-text">
    

    <a class="btn btn-outline-info m-2" href="?action=demarrer-groupe&vms='. $m["vms"] .'"> Démarrer  </a>
    <a class="btn btn-outline-info m-2" href="?action=arreter-groupe&vms='. $m["vms"] .'"> Arreter  </a>
    <a class="btn btn-outline-info m-2" href="?action=pause-groupe&vms='. $m["vms"] .'"> Pause  </a>
    <a class="btn btn-outline-info m-2" href="?action=reprendre-groupe&vms='. $m["vms"] .'"> Reprendre  </a>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header card-header-info">
                                <h4 class="card-title">État des machines de groupes</h4>
                            </div>
                            <div class="card-body">
