...
// on fait le clonage des disk en récupérant le chemin où se trouver le pool disk
// et le nom de pool, aprés la récupération de chemin et le nom on ajoute clone-nomDePool.
// on passe les params à la méthode CP qui nous permet de cloner un fichie.
