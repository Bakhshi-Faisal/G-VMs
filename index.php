    ...
    <div class="sidebar" data-color="azure" data-background-color="black" data-image="assets/img/bg2.jpg">
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="divers/gestionGroup.php">
                        <i class="material-icons">group_work</i>
                        <p>Gestion de Groupes</p>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="divers/changeip.php">
                        <i class="material-icons">group_work</i>
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" href="javascript:;">Gestion de VMs</a>
                </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header card-header-info">
                                <h4 class="card-title ">Machines Virtuelles</h4>
                            </div>
                            <div class="card-body">
...
$response = json_decode($response, true);
                                 ...
                                 echo '<table class="table table-responsive">
                                     ...
                                     foreach ($response as $m) {
                                                 echo
                                                                ...
                                                                echo '<td class=" text-center text-info">';



                                                                if($m['etat'] == "En cours")
                                                                {
                                                                  echo '<a class="text-info" href="?action=arreter-machine&uuid='. $m['uuid'] .'"> Arreter  la machine </a>'.str_repeat('&nbsp;', 5).'<a href=?action=pause-machine&uuid='. $m["uuid"] .'> Suspendre la machine </a>' ;

                                                                }
                                                                if($m['etat'] == "Shutoff")
                                                                {
                                                                  echo '<a href=?action=demarrer-machine&uuid='. $m["uuid"] .'> démarrer la machine </a>'.str_repeat('&nbsp;', 5).'<a href=?action=delete-machine&uuid='. $m["uuid"] .'> supprimer la machine </a>' ;

                                                                }
                                                                if($m['etat'] == "En pause")
                                                                {
                                                                  echo '<a href="?action=reprendre-machine&uuid='. $m["uuid"] .'"> reprendre la machine </a>' ;
                               ...
                               echo'</tbody>
                                     ...
                                     if ($action) {
                                         $url = "http://localhost/api/etats.php?uuid=" . $_GET['uuid'];
